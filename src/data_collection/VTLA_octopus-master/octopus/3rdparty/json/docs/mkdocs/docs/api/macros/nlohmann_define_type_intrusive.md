...
[`NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE`](01-doing/00-华威科实习/01-项目工作台/05-参考资料/ROS-git-worktree/src/VTLA_octopus-master/octopus/3rdparty/json/docs/mkdocs/docs/api/macros/nlohmann_define_type_non_intrusive.md), it can access private members. The first
