...
当前任务文件路径：`DOCS/03_工程/阶段二：数据清洗/04_debug/01_修改common_frames文件/L3微元任务/active/common_frames_debug_001_盘点common_frame影响面.md`
任务类别：数据计算类 / 测试基线类
...
dispatch:
  ...
  task_file: DOCS/03_工程/阶段二：数据清洗/04_debug/01_修改common_frames文件/L3微元任务/active/common_frames_debug_001_盘点common_frame影响面.md
...
上游接口定义位置：
- DOCS/03_工程/阶段二：数据清洗/04_debug/01_修改common_frames文件/修改计划.md
- DOCS/03_工程/阶段二：数据清洗/04_debug/01_修改common_frames文件/04_数据定义文件修改方案.md
...
1. `DOCS/03_工程/阶段二：数据清洗/04_debug/01_修改common_frames文件/修改计划.md`
...
- 不修改 `DOCS/03_工程/阶段二：数据清洗/02_service/` 下既有文档。
- 不修改业务实现代码。
...
用户指定路径：`DOCS/03_工程/阶段二：数据清洗/04_debug/01_修改common_frames文件/L3微元任务/active/common_frames_debug_001_盘点common_frame影响面.md`

实际读取路径：`DOCS/03_工程/阶段二：数据清洗/04_debug/01_修改common_frames文件/L3微元任务/active/common_frames_debug_001_盘点common_frame影响面.md`
...
- 约束文档：`DOCS/02_约束/阶段二任务体系/L3任务文件身份校验约束.md`、`DOCS/02_约束/阶段二任务体系/L3调度元数据约束.md`、`DOCS/02_约束/阶段二任务体系/双机协作写入边界.md`、`DOCS/02_约束/阶段二任务体系/功能分支接力流程.md`。
- 计划文档：`DOCS/03_工程/阶段二：数据清洗/04_debug/01_修改common_frames文件/修改计划.md`、`DOCS/03_工程/阶段二：数据清洗/04_debug/01_修改common_frames文件/04_数据定义文件修改方案.md`。
...
完成后归档到：`DOCS/03_工程/阶段二：数据清洗/04_debug/01_修改common_frames文件/L3微元任务/completed/common_frames_debug_001_盘点common_frame影响面.md`。
