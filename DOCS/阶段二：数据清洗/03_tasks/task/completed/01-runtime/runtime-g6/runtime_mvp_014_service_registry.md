...
- `DOCS/阶段二：数据清洗/01_runtime_mvp/L2数据定义/ServiceRegistry.md`
- `DOCS/阶段二：数据清洗/01_runtime_mvp/L2数据定义/ServiceBinding.md`
- `DOCS/阶段二：数据清洗/01_runtime_mvp/L2能力模块/07_Fake Service模块.md`
- `DOCS/阶段二：数据清洗/03_tasks/task/completed/runtime-g6/runtime_mvp_013_service_dispatch_types.md`（上游 L3 已完成）
