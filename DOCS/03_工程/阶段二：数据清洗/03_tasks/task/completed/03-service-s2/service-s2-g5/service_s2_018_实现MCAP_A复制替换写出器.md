...
当前任务文件路径：`DOCS/03_工程/阶段二：数据清洗/03_tasks/task/active/service-s2-g5/service_s2_018_实现MCAP_A复制替换写出器.md`
任务类别：数据读写类
...
dispatch:
  ...
  task_file: DOCS/03_工程/阶段二：数据清洗/03_tasks/task/active/service-s2-g5/service_s2_018_实现MCAP_A复制替换写出器.md
  group: service-s2-g5
  branch: service-s2
  wave: 2
...
1. `DOCS/03_工程/阶段二：数据清洗/03_tasks/task/completed/03-service-s2/service-s2-g5/service_s2_017_定义MCAP_A写出配置摘要和契约.md`
...
```text
用户指定路径：DOCS/03_工程/阶段二：数据清洗/03_tasks/task/active/service-s2-g5/service_s2_018_实现MCAP_A复制替换写出器.md
实际读取路径：DOCS/03_工程/阶段二：数据清洗/03_tasks/task/active/service-s2-g5/service_s2_018_实现MCAP_A复制替换写出器.md
...
- 上游依赖：已读取归档任务 `DOCS/03_工程/阶段二：数据清洗/03_tasks/task/completed/03-service-s2/service-s2-g5/service_s2_017_定义MCAP_A写出配置摘要和契约.md`，确认 `MCAP_A_WriterConfig`、`MCAP_A_WritePlan`、`MCAP_A_OutputContract`、`MCAP_A_WriterResult` 可用。
