...
- `DOCS/阶段二：数据清洗/03_tasks/task/active/runtime-g6/runtime_mvp_016_pipeline_dispatcher.md`（当前任务）
- `DOCS/阶段二：数据清洗/03_tasks/task/active/runtime-g6/runtime_mvp_015_single_scene_dispatcher.md`（上游依赖）
- `DOCS/阶段二：数据清洗/03_tasks/task/active/runtime-g6/runtime_mvp_014_service_registry.md`（上游依赖）
- `DOCS/阶段二：数据清洗/03_tasks/task/active/runtime-g6/runtime_mvp_013_service_dispatch_types.md`（上游依赖）
- `DOCS/阶段二：数据清洗/01_runtime_mvp/L2能力模块/06_场景注册与Service调度模块.md`
- `DOCS/阶段二：数据清洗/01_runtime_mvp/L2数据定义/SceneDispatchPlan.md`
- `DOCS/阶段二：数据清洗/01_runtime_mvp/L2数据定义/PipelineResult.md`
- `DOCS/阶段二：数据清洗/01_runtime_mvp/L2数据定义/SceneResult.md`
