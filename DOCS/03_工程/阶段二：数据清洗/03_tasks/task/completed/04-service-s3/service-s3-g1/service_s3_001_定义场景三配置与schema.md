...
当前任务文件路径：`DOCS/03_工程/阶段二：数据清洗/03_tasks/task/active/service-s3-g1/service_s3_001_定义场景三配置与schema.md`  
任务类别：数据定义类  
...
dispatch:
  ...
  task_file: DOCS/03_工程/阶段二：数据清洗/03_tasks/task/active/service-s3-g1/service_s3_001_定义场景三配置与schema.md
  group: service-s3-g1
  branch: service-s3
  wave: 1
...
2. `DOCS/03_工程/阶段二：数据清洗/02_service/场景三/L2数据定义/Scene3AlignmentConfig.md`
3. `DOCS/03_工程/阶段二：数据清洗/02_service/场景三/L2数据定义/TargetFieldMapping.md`
4. `DOCS/03_工程/阶段二：数据清洗/02_service/场景二/L2数据定义/McapA.md`
5. `DOCS/03_工程/阶段二：数据清洗/02_service/场景二/L2数据定义/McapAWriteSummary.md`

### 必读相关微元任务记录

1. 如果存在，读取 `DOCS/03_工程/阶段二：数据清洗/03_tasks/task/completed/03-service-s2/service-s2-g5/` 下 MCAP_A 生成器相关 L3 执行摘要。
...
```text
用户指定路径：DOCS/03_工程/阶段二：数据清洗/03_tasks/task/active/service-s3-g1/service_s3_001_定义场景三配置与schema.md
实际读取路径：DOCS/03_工程/阶段二：数据清洗/03_tasks/task/active/service-s3-g1/service_s3_001_定义场景三配置与schema.md
...
- 相关 L3 历史记录：已找到并读取 `DOCS/03_工程/阶段二：数据清洗/03_tasks/task/completed/03-service-s2/service-s2-g5/service_s2_017_定义MCAP_A写出配置摘要和契约.md`，其执行模式作为本 L3 参考。
