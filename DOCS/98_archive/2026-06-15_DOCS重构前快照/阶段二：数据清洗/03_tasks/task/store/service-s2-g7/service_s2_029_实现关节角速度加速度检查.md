...
当前任务文件路径：`DOCS/阶段二：数据清洗/03_tasks/task/active/service-s2-g7/service_s2_029_实现关节角速度加速度检查.md`
任务类别：数据计算类
...
dispatch:
  ...
  task_file: DOCS/阶段二：数据清洗/03_tasks/task/active/service-s2-g7/service_s2_029_实现关节角速度加速度检查.md
  group: service-s2-g7
  branch: service-s2
  wave: 3
...
1. `DOCS/阶段二：数据清洗/03_tasks/task/completed/03-service-s2/service-s2-g7/service_s2_026_睿尔曼SDK本地部署与IK限位函数自检.md`
2. `DOCS/阶段二：数据清洗/03_tasks/task/completed/03-service-s2/service-s2-g7/service_s2_028_实现MCAP_B与IkSolveSummary对齐读取和连续片段切分.md`
