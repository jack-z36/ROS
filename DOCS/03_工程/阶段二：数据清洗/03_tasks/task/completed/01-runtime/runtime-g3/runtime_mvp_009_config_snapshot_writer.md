...
1. `DOCS/03_工程/阶段二：数据清洗/03_tasks/task/runtime-g2/runtime_mvp_006_run_context_attach_run_dir.md`
2. `DOCS/03_工程/阶段二：数据清洗/03_tasks/task/runtime-g3/runtime_mvp_007_runtime_config_types.md`
3. `DOCS/03_工程/阶段二：数据清洗/03_tasks/task/runtime-g3/runtime_mvp_008_config_load_and_overrides.md`
4. `DOCS/03_工程/阶段二：数据清洗/01_runtime_mvp/L2能力模块/03_配置加载与配置快照模块.md`
...
- `DOCS/03_工程/阶段二：数据清洗/01_runtime_mvp/L2数据定义/RunDirectoryLayout.md`
- `DOCS/03_工程/阶段二：数据清洗/01_runtime_mvp/L2数据定义/RunArtifactPath.md`
