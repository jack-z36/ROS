...
DEFAULT_OUTPUT_CONFIG = WORKSPACE_DIR / "config/data_clean_calibrated.yaml"
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--config", default=str(WORKSPACE_DIR / "config/data_clean_smoke_test.yaml"))
