...
- DOCS/03_工程/阶段二：数据清洗/03_tasks/task/active/runtime-g8/
- DOCS/03_工程/阶段二：数据清洗/03_tasks/task/active/runtime-g9/
...
4. `DOCS/03_工程/阶段二：数据清洗/01_runtime_mvp/L2能力模块/08_结构化日志模块.md`
5. `DOCS/03_工程/阶段二：数据清洗/01_runtime_mvp/L2能力模块/09_Manifest与错误摘要模块.md`
6. `DOCS/03_工程/阶段二：数据清洗/01_runtime_mvp/L2数据定义/RuntimeSmokeTestCase.md`
7. `DOCS/03_工程/阶段二：数据清洗/01_runtime_mvp/L2数据定义/RuntimeSmokeTestResult.md`
8. `DOCS/03_工程/阶段二：数据清洗/01_runtime_mvp/L2数据定义/SceneDispatchPlan.md`
9. `DOCS/03_工程/阶段二：数据清洗/01_runtime_mvp/L2数据定义/FakeServicePlan.md`
10. `DOCS/03_工程/阶段二：数据清洗/01_runtime_mvp/L2数据定义/PipelineResult.md`

### 必读相关微元任务记录

1. `DOCS/03_工程/阶段二：数据清洗/03_tasks/task/active/runtime-g6/runtime_mvp_015_single_scene_dispatcher.md`
2. `DOCS/03_工程/阶段二：数据清洗/03_tasks/task/active/runtime-g6/runtime_mvp_016_pipeline_dispatcher.md`
3. `DOCS/03_工程/阶段二：数据清洗/03_tasks/task/active/runtime-g7/runtime_mvp_022_fake_service_dispatch_adapter.md`
4. `DOCS/03_工程/阶段二：数据清洗/03_tasks/task/active/runtime-g8/runtime_mvp_025_run_log_writer.md`
5. `DOCS/03_工程/阶段二：数据清洗/03_tasks/task/active/runtime-g9/runtime_mvp_027_processing_manifest_writer.md`
6. `DOCS/03_工程/阶段二：数据清洗/03_tasks/task/active/runtime-g9/runtime_mvp_029_run_result_index_writer.md`
...
- `DOCS/03_工程/阶段二：数据清洗/01_runtime_mvp/L2能力模块/10_Runtime smoke test模块.md`
- `DOCS/03_工程/阶段二：数据清洗/03_tasks/task/active/runtime-g10/runtime_mvp_030_runtime_smoke_test_types.md`
