...
当前任务文件路径：`DOCS/03_工程/阶段二：数据清洗/03_tasks/task/active/service-s3-g6/service_s3_020_实现alignment_index与report_sidecar写出.md`  
任务类别：数据读写类  
...
dispatch:
  ...
  task_file: DOCS/03_工程/阶段二：数据清洗/03_tasks/task/active/service-s3-g6/service_s3_020_实现alignment_index与report_sidecar写出.md
  group: service-s3-g6
  branch: service-s3
  wave: 2
...
1. `DOCS/03_工程/阶段二：数据清洗/03_tasks/task/completed/04-service-s3/service-s3-g5/service_s3_017_实现AlignmentReport草稿统计生成.md`
2. `DOCS/03_工程/阶段二：数据清洗/03_tasks/task/completed/04-service-s3/service-s3-g6/service_s3_019_定义写出摘要与final报告补齐类型.md`
...
| 项目 | 结果 |
|---|---|
| 用户指定路径 | `DOCS/03_工程/阶段二：数据清洗/03_tasks/task/active/service-s3-g6/service_s3_020_实现alignment_index与report_sidecar写出.md` |
| 实际读取路径 | 匹配 |
