...
上游接口定义位置：
- DOCS/阶段二：数据清洗/03_tasks/task/active/runtime-g6/runtime_mvp_016_pipeline_dispatcher.md
...
- DOCS/阶段二：数据清洗/03_tasks/task/active/runtime-g9/runtime_mvp_029_run_result_index_writer.md
- DOCS/阶段二：数据清洗/03_tasks/task/active/runtime-g10/runtime_mvp_030_runtime_smoke_test_types.md
- DOCS/阶段二：数据清洗/03_tasks/task/active/runtime-g10/runtime_mvp_031_single_and_pipeline_fake_success_smoke.md
...
4. `DOCS/阶段二：数据清洗/01_runtime_mvp/L2能力模块/09_Manifest与错误摘要模块.md`
5. `DOCS/阶段二：数据清洗/01_runtime_mvp/L2数据定义/RuntimeSmokeTestCase.md`
6. `DOCS/阶段二：数据清洗/01_runtime_mvp/L2数据定义/RuntimeSmokeTestResult.md`
7. `DOCS/阶段二：数据清洗/01_runtime_mvp/L2数据定义/FakeServiceBehavior.md`
8. `DOCS/阶段二：数据清洗/01_runtime_mvp/L2数据定义/PipelineResult.md`
9. `DOCS/阶段二：数据清洗/01_runtime_mvp/L2数据定义/RuntimeErrorRef.md`
10. `DOCS/阶段二：数据清洗/01_runtime_mvp/L2数据定义/ErrorSummary.md`
11. `DOCS/阶段二：数据清洗/01_runtime_mvp/L2数据定义/RunResultIndex.md`

### 必读相关微元任务记录

1. `DOCS/阶段二：数据清洗/03_tasks/task/active/runtime-g6/runtime_mvp_016_pipeline_dispatcher.md`
2. `DOCS/阶段二：数据清洗/03_tasks/task/active/runtime-g7/runtime_mvp_020_fake_service_types.md`
3. `DOCS/阶段二：数据清洗/03_tasks/task/active/runtime-g7/runtime_mvp_021_fake_service_result_generator.md`
4. `DOCS/阶段二：数据清洗/03_tasks/task/active/runtime-g7/runtime_mvp_022_fake_service_dispatch_adapter.md`
5. `DOCS/阶段二：数据清洗/03_tasks/task/active/runtime-g9/runtime_mvp_026_manifest_error_types.md`
6. `DOCS/阶段二：数据清洗/03_tasks/task/active/runtime-g9/runtime_mvp_028_error_summary_writer.md`
7. `DOCS/阶段二：数据清洗/03_tasks/task/active/runtime-g9/runtime_mvp_029_run_result_index_writer.md`
8. `DOCS/阶段二：数据清洗/03_tasks/task/active/runtime-g10/runtime_mvp_030_runtime_smoke_test_types.md`
9. `DOCS/阶段二：数据清洗/03_tasks/task/active/runtime-g10/runtime_mvp_031_single_and_pipeline_fake_success_smoke.md`
