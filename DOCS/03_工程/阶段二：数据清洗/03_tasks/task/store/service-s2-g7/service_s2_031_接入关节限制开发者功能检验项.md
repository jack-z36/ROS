...
当前任务文件路径：`DOCS/03_工程/阶段二：数据清洗/03_tasks/task/active/service-s2-g7/service_s2_031_接入关节限制开发者功能检验项.md`
任务类别：流程编排类
...
dispatch:
  ...
  task_file: DOCS/03_工程/阶段二：数据清洗/03_tasks/task/active/service-s2-g7/service_s2_031_接入关节限制开发者功能检验项.md
  group: service-s2-g7
  branch: service-s2
  wave: 4
...
上游接口定义位置：
- DOCS/03_工程/阶段二：数据清洗/03_tasks/task/completed/03-service-s2/service-s2-g7/service_s2_029_实现关节角速度加速度检查.md
- DOCS/03_工程/阶段二：数据清洗/03_tasks/task/completed/03-service-s2/service-s2-g7/service_s2_030_实现workspace半径与禁区检查.md
- DOCS/03_工程/阶段二：数据清洗/02_service/场景二/L2数据定义/JointConstraintCheckResult.md
...
2. `DOCS/03_工程/阶段二：数据清洗/02_service/场景二/L2数据定义/JointConstraintCheckResult.md`
3. `DOCS/02_约束/阶段二任务体系/开发者验收入口约束.md`

### 必读相关微元任务记录

1. `DOCS/03_工程/阶段二：数据清洗/03_tasks/task/completed/03-service-s2/service-s2-g7/service_s2_029_实现关节角速度加速度检查.md`
2. `DOCS/03_工程/阶段二：数据清洗/03_tasks/task/completed/03-service-s2/service-s2-g7/service_s2_030_实现workspace半径与禁区检查.md`
