...
- DOCS/03_工程/阶段二：数据清洗/03_tasks/task/active/runtime-g3/runtime_mvp_007_runtime_config_types.md
...
2. `DOCS/03_工程/阶段二：数据清洗/01_runtime_mvp/L2数据定义/ProcessingManifest.md`
3. `DOCS/03_工程/阶段二：数据清洗/01_runtime_mvp/L2数据定义/ErrorSummary.md`
4. `DOCS/03_工程/阶段二：数据清洗/01_runtime_mvp/L2数据定义/RunResultIndex.md`
5. `DOCS/03_工程/阶段二：数据清洗/01_runtime_mvp/L2数据定义/PipelineResult.md`
6. `DOCS/03_工程/阶段二：数据清洗/01_runtime_mvp/L2数据定义/RuntimeErrorRef.md`
7. `DOCS/03_工程/阶段二：数据清洗/01_runtime_mvp/L2数据定义/RunLogFile.md`
8. `DOCS/03_工程/阶段二：数据清洗/01_runtime_mvp/L2数据定义/RuntimeLogWriteResult.md`
...
4. `DOCS/03_工程/阶段二：数据清洗/03_tasks/task/active/runtime-g2/runtime_mvp_004_run_directory_types.md`
5. `DOCS/03_工程/阶段二：数据清洗/03_tasks/task/active/runtime-g8/runtime_mvp_023_structured_log_types.md`
...
- 未找到相关 L3 历史记录：`DOCS/03_工程/阶段二：数据清洗/03_tasks/task/active/runtime-g1/runtime_mvp_001_定义Runtime上下文Types.md` 等文件在 `active/` 目录下不存在，已在 `completed/runtime-g1/` 找到完成记录。
