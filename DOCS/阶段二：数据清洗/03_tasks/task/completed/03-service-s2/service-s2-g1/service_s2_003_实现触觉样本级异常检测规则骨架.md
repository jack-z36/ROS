...
```text
用户指定路径：DOCS/阶段二：数据清洗/03_tasks/task/active/service-s2-g1/service_s2_003_实现触觉样本级异常检测规则骨架.md
实际读取路径：DOCS/阶段二：数据清洗/03_tasks/task/active/service-s2-g1/service_s2_003_实现触觉样本级异常检测规则骨架.md
