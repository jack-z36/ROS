---
title: "C、C++: 轨迹文件 | 睿尔曼智能科技"
source: "https://develop.realman-robotics.com/robot4th/apic/classes/trajectoryfile/"
author:
...
## 查询轨迹列表rm\_get\_trajectory\_file\_list()
...
*可以跳转 [rm\_robot\_handle](https://develop.realman-robotics.com/robot4th/apic/struct/robotHandle/) 和 [rm\_trajectory\_list\_t](https://develop.realman-robotics.com/robot4th/apic/struct/trajectoryinfolist/) 查阅结构体详细描述。*
...
## 开始运行指定轨迹rm\_set\_run\_trajectory()
...
## 删除指定轨迹文件rm\_delete\_trajectory\_file()
...
## 保存轨迹文件rm\_save\_trajectory\_file()
