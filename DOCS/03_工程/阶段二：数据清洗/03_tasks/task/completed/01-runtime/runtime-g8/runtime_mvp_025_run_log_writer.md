...
任务类别：数据读写类  
来源 L2 文件：`DOCS/03_工程/阶段二：数据清洗/01_runtime_mvp/L2能力模块/08_结构化日志模块.md`
...
- DOCS/03_工程/阶段二：数据清洗/03_tasks/task/active/runtime-g8/runtime_mvp_024_runtime_log_event_converter.md
...
1. `DOCS/03_工程/阶段二：数据清洗/01_runtime_mvp/L2能力模块/08_结构化日志模块.md`
2. `DOCS/03_工程/阶段二：数据清洗/01_runtime_mvp/L2数据定义/RunLogFile.md`
3. `DOCS/03_工程/阶段二：数据清洗/01_runtime_mvp/L2数据定义/RuntimeLogEvent.md`
4. `DOCS/03_工程/阶段二：数据清洗/01_runtime_mvp/L2数据定义/RuntimeLogWriteResult.md`
5. `DOCS/03_工程/阶段二：数据清洗/01_runtime_mvp/L2数据定义/RunDirectoryLayout.md`
6. `DOCS/03_工程/阶段二：数据清洗/01_runtime_mvp/L2数据定义/RunArtifactPath.md`

### 必读相关微元任务记录

1. `DOCS/03_工程/阶段二：数据清洗/03_tasks/task/active/runtime-g2/runtime_mvp_004_run_directory_types.md`
2. `DOCS/03_工程/阶段二：数据清洗/03_tasks/task/active/runtime-g8/runtime_mvp_023_structured_log_types.md`
3. `DOCS/03_工程/阶段二：数据清洗/03_tasks/task/active/runtime-g8/runtime_mvp_024_runtime_log_event_converter.md`
...
- 读取了 `DOCS/03_工程/阶段二：数据清洗/01_runtime_mvp/L2数据定义/RunLogFile.md`
- 读取了 `DOCS/03_工程/阶段二：数据清洗/01_runtime_mvp/L2数据定义/RuntimeLogEvent.md`
- 读取了 `DOCS/03_工程/阶段二：数据清洗/01_runtime_mvp/L2数据定义/RuntimeLogWriteResult.md`
- 读取了 `DOCS/03_工程/阶段二：数据清洗/01_runtime_mvp/L2数据定义/RunDirectoryLayout.md`
- 读取了 `DOCS/03_工程/阶段二：数据清洗/01_runtime_mvp/L2数据定义/RunArtifactPath.md`
