...
当前任务文件路径：`DOCS/阶段二：数据清洗/03_tasks/task/active/service-s2-g6/service_s2_024_实现RM65_SDK_IK求解适配器.md`
任务类别：数据计算类
...
dispatch:
  ...
  task_file: DOCS/阶段二：数据清洗/03_tasks/task/active/service-s2-g6/service_s2_024_实现RM65_SDK_IK求解适配器.md
  group: service-s2-g6
  branch: service-s2
  wave: 3
...
- DOCS/阶段二：数据清洗/02_service/场景二/L2数据定义/Rm65IkConfig.md
...
3. `DOCS/阶段二：数据清洗/02_service/场景二/L2数据定义/Rm65IkSampleResult.md`
