...
| `blueprint` | 开发蓝图 | 新 ACT 的真实 tick 调用方向与六层落点 | `agent_context/03_ACT微元设计与协作.md`、`agent_context/06_types层设计.md`、`agent_context/07_config层设计.md`、`agent_context/08_repo层设计.md`、`agent_context/09_service层设计.md`、`agent_context/10_runtime层设计.md`、`agent_context/11_ui层设计.md` | `## tick 状态机`、`## 六层落点` | 函数签名、状态所有权、依赖方向 |
