...
当前任务文件路径：`DOCS/阶段二：数据清洗/04_debug/01_修改common_frames文件/L3微元任务/active/common_frames_debug_004_建立睿尔曼官方API环境自检.md`
任务类别：数据读写类 / 环境自检类
...
dispatch:
  ...
  task_file: DOCS/阶段二：数据清洗/04_debug/01_修改common_frames文件/L3微元任务/active/common_frames_debug_004_建立睿尔曼官方API环境自检.md
...
| 项目 | 结论 |
|---|---|
| 用户指定路径 | `DOCS/阶段二：数据清洗/04_debug/01_修改common_frames文件/L3微元任务/active/common_frames_debug_004_建立睿尔曼官方API环境自检.md` |
| 实际读取路径 | 同上 |
