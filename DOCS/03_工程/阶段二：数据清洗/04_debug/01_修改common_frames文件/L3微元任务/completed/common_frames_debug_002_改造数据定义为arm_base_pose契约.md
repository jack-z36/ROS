...
当前任务文件路径：`DOCS/03_工程/阶段二：数据清洗/04_debug/01_修改common_frames文件/L3微元任务/active/common_frames_debug_002_改造数据定义为arm_base_pose契约.md`
任务类别：数据定义类 / 代码类型类
来源计划文件：`DOCS/03_工程/阶段二：数据清洗/04_debug/01_修改common_frames文件/04_数据定义文件修改方案.md`
...
dispatch:
  ...
  task_file: DOCS/03_工程/阶段二：数据清洗/04_debug/01_修改common_frames文件/L3微元任务/active/common_frames_debug_002_改造数据定义为arm_base_pose契约.md
...
- 不修改 `DOCS/03_工程/阶段二：数据清洗/02_service/` 既有 L2 文档。
...
1. `DOCS/03_工程/阶段二：数据清洗/04_debug/01_修改common_frames文件/04_数据定义文件修改方案.md`
...
- 用户指定路径：`DOCS/03_工程/阶段二：数据清洗/04_debug/01_修改common_frames文件/L3微元任务/active/common_frames_debug_002_改造数据定义为arm_base_pose契约.md`
- 实际读取路径：一致
...
1. **计划/约束文档**：
   - `DOCS/03_工程/阶段二：数据清洗/04_debug/01_修改common_frames文件/04_数据定义文件修改方案.md` — 了解 arm-base pose 数据定义方案
   - `DOCS/03_工程/阶段二：数据清洗/04_debug/01_修改common_frames文件/L3微元任务/README.md` — 了解任务 DAG 和归档规则
