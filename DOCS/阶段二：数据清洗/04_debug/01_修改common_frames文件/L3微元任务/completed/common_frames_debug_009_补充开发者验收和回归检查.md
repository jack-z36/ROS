...
当前任务文件路径：`DOCS/阶段二：数据清洗/04_debug/01_修改common_frames文件/L3微元任务/active/common_frames_debug_009_补充开发者验收和回归检查.md`
任务类别：流程编排类
...
dispatch:
  ...
  task_file: DOCS/阶段二：数据清洗/04_debug/01_修改common_frames文件/L3微元任务/active/common_frames_debug_009_补充开发者验收和回归检查.md
...
1. `DOCS/阶段二：数据清洗/约束文件/开发者验收入口约束.md`
2. `DOCS/阶段二：数据清洗/02_service/场景一/功能模块清单.md`
3. `DOCS/阶段二：数据清洗/02_service/场景二/功能模块清单.md`
...
- 用户指定路径：`DOCS/阶段二：数据清洗/04_debug/01_修改common_frames文件/L3微元任务/active/common_frames_debug_009_补充开发者验收和回归检查.md`
- 实际读取路径：同上 ✅
