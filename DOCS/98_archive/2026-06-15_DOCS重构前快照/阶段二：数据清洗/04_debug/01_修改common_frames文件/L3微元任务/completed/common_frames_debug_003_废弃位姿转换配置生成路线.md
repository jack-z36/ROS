...
当前任务文件路径：`DOCS/阶段二：数据清洗/04_debug/01_修改common_frames文件/L3微元任务/active/common_frames_debug_003_废弃位姿转换配置生成路线.md`
任务类别：流程编排类 / 数据定义类
来源计划文件：`DOCS/阶段二：数据清洗/04_debug/01_修改common_frames文件/01_删除位姿转换配置生成模块.md`
...
dispatch:
  ...
  task_file: DOCS/阶段二：数据清洗/04_debug/01_修改common_frames文件/L3微元任务/active/common_frames_debug_003_废弃位姿转换配置生成路线.md
...
上游接口定义位置：
- DOCS/阶段二：数据清洗/02_service/场景一/L2能力模块/位姿转换配置生成.md
- src/data_clean/ui/mcap_calibration_wizard.py
- src/data_clean/repo/config/mcap_process_config.py
...
1. `DOCS/阶段二：数据清洗/04_debug/01_修改common_frames文件/01_删除位姿转换配置生成模块.md`
2. `DOCS/阶段二：数据清洗/02_service/场景一/L2能力模块/位姿转换配置生成.md`
3. `DOCS/阶段二：数据清洗/02_service/场景一/执行约束.md`
...
rg -n "FrameAlignmentConfig|common_anchor|scene1_frame_alignment_config|config_is_calibrated|common_frame" src/data_clean DOCS/阶段二：数据清洗/02_service/场景一
...
- 用户指定路径: `DOCS/阶段二：数据清洗/04_debug/01_修改common_frames文件/L3微元任务/active/common_frames_debug_003_废弃位姿转换配置生成路线.md`
- 实际读取路径: 同上
...
- `DOCS/阶段二：数据清洗/04_debug/01_修改common_frames文件/01_删除位姿转换配置生成模块.md`
- `DOCS/阶段二：数据清洗/02_service/场景一/L2能力模块/位姿转换配置生成.md`
- `DOCS/阶段二：数据清洗/02_service/场景一/执行约束.md`
- `DOCS/阶段二：数据清洗/04_debug/01_修改common_frames文件/L3微元任务/README.md`
- `src/data_clean/repo/config/mcap_process_config.py`
- `src/data_clean/ui/scene1_dev_checks.py`
