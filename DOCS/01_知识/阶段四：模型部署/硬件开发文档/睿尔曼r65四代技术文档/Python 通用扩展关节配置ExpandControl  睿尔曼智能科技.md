---
title: "Python: 通用扩展关节配置ExpandControl | 睿尔曼智能科技"
source: "https://develop.realman-robotics.com/robot4th/apipython/classes/expandControl/"
author:
...
## 扩展关节速度环控制rm\_set\_expand\_speed()
...
| 名称 | 类型 | 说明 |
| --- | --- | --- |
| `speed` | `int` | 速度百分比，-100~100：   1\. speed<0：扩展关节向下运动；   2\. speed>0：扩展关节向上运动；   3\. speed=0：扩展关节停止运动。 |
...
## 获取扩展关节状态rm\_get\_expand\_state()
...
| 参数 | 类型 | 说明 |
| --- | --- | --- |
| `rm_expand_state_t` | `dict[str,any]` | 获取到的扩展关节状态字典，键为rm\_expand\_state\_t结构体的字段名称 |
