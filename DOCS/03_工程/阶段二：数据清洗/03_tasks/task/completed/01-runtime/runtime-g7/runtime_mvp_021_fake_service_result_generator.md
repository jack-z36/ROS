...
1. `DOCS/03_工程/阶段二：数据清洗/03_tasks/task/active/runtime-g7/runtime_mvp_020_fake_service_types.md`
...
- `DOCS/03_工程/阶段二：数据清洗/03_tasks/task/completed/runtime-g7/runtime_mvp_020_fake_service_types.md` - 了解已有类型定义
- `DOCS/03_工程/阶段二：数据清洗/01_runtime_mvp/L2能力模块/07_Fake Service模块.md` - 了解能力模块定义
- `DOCS/03_工程/阶段二：数据清洗/01_runtime_mvp/L2数据定义/FakeServicePlan.md` - 了解数据定义
- `DOCS/03_工程/阶段二：数据清洗/01_runtime_mvp/L2数据定义/FakeServiceResult.md` - 了解数据定义
