...
- `DOCS/阶段二：数据清洗/03_tasks/task/active/runtime-g4/runtime_mvp_017_config_precheck_types.md`（上游依赖，已有代码文件）
- `DOCS/阶段二：数据清洗/03_tasks/task/active/runtime-g4/runtime_mvp_018_config_prechecker.md`（上游依赖，已有代码文件）
- `DOCS/阶段二：数据清洗/01_runtime_mvp/L2能力模块/04_配置预检查模块.md`
- `DOCS/阶段二：数据清洗/01_runtime_mvp/L2能力模块/03_配置加载与配置快照模块.md`
- `DOCS/阶段二：数据清洗/01_runtime_mvp/L2能力模块/05_输入产物预检查模块.md`
- `DOCS/阶段二：数据清洗/01_runtime_mvp/L2数据定义/ConfigPrecheckResult.md`
- `DOCS/阶段二：数据清洗/01_runtime_mvp/L2数据定义/ConfigPrecheckIssue.md`
