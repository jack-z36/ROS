...
- DOCS/03_工程/阶段二：数据清洗/03_tasks/task/active/runtime-g3/runtime_mvp_009_config_snapshot_writer.md
...
3. `DOCS/03_工程/阶段二：数据清洗/01_runtime_mvp/L2数据定义/ConfigSnapshot.md`
...
2. `DOCS/03_工程/阶段二：数据清洗/03_tasks/task/active/runtime-g3/runtime_mvp_009_config_snapshot_writer.md`
