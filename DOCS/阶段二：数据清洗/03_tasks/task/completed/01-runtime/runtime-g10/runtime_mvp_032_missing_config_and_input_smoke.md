...
上游接口定义位置：
- DOCS/阶段二：数据清洗/03_tasks/task/completed/runtime-g3/
- DOCS/阶段二：数据清洗/03_tasks/task/completed/runtime-g4/
- DOCS/阶段二：数据清洗/03_tasks/task/active/runtime-g5/
- DOCS/阶段二：数据清洗/03_tasks/task/active/runtime-g6/runtime_mvp_015_single_scene_dispatcher.md
...
2. `DOCS/阶段二：数据清洗/01_runtime_mvp/L2能力模块/04_配置预检查模块.md`
3. `DOCS/阶段二：数据清洗/01_runtime_mvp/L2能力模块/05_输入产物预检查模块.md`
4. `DOCS/阶段二：数据清洗/01_runtime_mvp/L2数据定义/RuntimeSmokeTestCase.md`
5. `DOCS/阶段二：数据清洗/01_runtime_mvp/L2数据定义/RuntimeSmokeTestResult.md`
6. `DOCS/阶段二：数据清洗/01_runtime_mvp/L2数据定义/EffectiveRuntimeConfig.md`
7. `DOCS/阶段二：数据清洗/01_runtime_mvp/L2数据定义/ConfigPrecheckResult.md`
8. `DOCS/阶段二：数据清洗/01_runtime_mvp/L2数据定义/InputArtifactPrecheckSummary.md`
9. `DOCS/阶段二：数据清洗/01_runtime_mvp/L2数据定义/RuntimeErrorRef.md`

### 必读相关微元任务记录

1. `DOCS/阶段二：数据清洗/03_tasks/task/completed/runtime-g3/runtime_mvp_007_runtime_config_types.md`
2. `DOCS/阶段二：数据清洗/03_tasks/task/completed/runtime-g3/runtime_mvp_008_config_load_and_overrides.md`
3. `DOCS/阶段二：数据清洗/03_tasks/task/completed/runtime-g4/runtime_mvp_017_config_precheck_types.md`
4. `DOCS/阶段二：数据清洗/03_tasks/task/completed/runtime-g4/runtime_mvp_018_config_prechecker.md`
5. `DOCS/阶段二：数据清洗/03_tasks/task/active/runtime-g5/runtime_mvp_010_input_artifact_precheck_types.md`
6. `DOCS/阶段二：数据清洗/03_tasks/task/active/runtime-g5/runtime_mvp_012_input_artifact_min_boundary_check.md`
