...
当前任务文件路径：`DOCS/阶段二：数据清洗/04_debug/01_修改common_frames文件/L3微元任务/active/common_frames_debug_007_改造cleaned_MCAP输出arm_base_TCP_pose.md`
任务类别：数据读写类
...
dispatch:
  ...
  task_file: DOCS/阶段二：数据清洗/04_debug/01_修改common_frames文件/L3微元任务/active/common_frames_debug_007_改造cleaned_MCAP输出arm_base_TCP_pose.md
...
3. `DOCS/阶段二：数据清洗/02_service/场景一/L2数据定义/CleanedMcap.md`
...
| 校验项 | 结果 |
|---|---|
| 用户指定路径 | `DOCS/阶段二：数据清洗/04_debug/01_修改common_frames文件/L3微元任务/active/common_frames_debug_007_改造cleaned_MCAP输出arm_base_TCP_pose.md` |
| 实际读取路径 | 同上 |
