...
/*======================================
函数名：saveData
参数：  char const* bytes_to_encode--需要编码的目标字符串
unsigned int in_len --- 目标字符串长度
功能：对字符串数据进行编码
返回值：编码后的数据
======================================*/
std::string CBase64::encode(char const* bytes_to_encode, unsigned int in_len)
{
	std::string ret;
	int i = 0;
	int j = 0;
...
/*======================================
函数名：parseData
参数：std::string const& encoded_string
需要编码的目标字符串
功能：对字符串数据进行解码
返回值：解码后的数据
======================================*/
