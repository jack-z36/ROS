...
当前任务文件路径：`DOCS/阶段二：数据清洗/04_debug/01_修改common_frames文件/L3微元任务/active/common_frames_debug_006_实现官方API生成arm_base_TCP位姿.md`
任务类别：数据计算类
...
dispatch:
  ...
  task_file: DOCS/阶段二：数据清洗/04_debug/01_修改common_frames文件/L3微元任务/active/common_frames_debug_006_实现官方API生成arm_base_TCP位姿.md
...
| 项目 | 内容 | 一致性 |
|------|------|--------|
| 用户指定路径 | `DOCS/阶段二：数据清洗/04_debug/01_修改common_frames文件/L3微元任务/active/common_frames_debug_006_实现官方API生成arm_base_TCP位姿.md` | — |
| 实际读取路径 | `/home/hit/ROS/DOCS/阶段二：数据清洗/04_debug/01_修改common_frames文件/L3微元任务/active/common_frames_debug_006_实现官方API生成arm_base_TCP位姿.md` | ✅ |
